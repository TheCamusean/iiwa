...
#include "iiwa/GraspingAction_class.h"


GraspingAction::GraspingAction(std::string name , bool& is_free) :
...
void GraspingAction::executeCB(const iiwa::BinPickingGoalConstPtr &goal)
{
...
bool GraspingAction::executeCycle()
{
